...
const allChats = TryCatch(async(req,res,next)=>{
   ...
   const transformedChat = await Promise.all(
        chats.map(async({name,_id,members, groupChat,creator})=>{
...
const allMessages = TryCatch(async(req,res,next)=>{
   ...
   const transformedMessage = 
        messages.map(({content,_id,attachments, sender,createdAt,chat})=>({
            _id,
            attachments,
            content,
            createdAt,
